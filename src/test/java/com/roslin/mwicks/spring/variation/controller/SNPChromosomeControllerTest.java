...
public class SNPChromosomeControllerTest extends AbstractTestController {
    ...
    private ServiceSNPChromosome1 serviceSNPChromosome1Mock;
    private ServiceSNPChromosome3 serviceSNPChromosome3Mock;
    private ServiceSNPChromosome4 serviceSNPChromosome4Mock;
    private ServiceSNPChromosome5 serviceSNPChromosome5Mock;
    private ServiceSNPChromosome6 serviceSNPChromosome6Mock;
    private ServiceSNPChromosome7 serviceSNPChromosome7Mock;
    private ServiceSNPChromosome8 serviceSNPChromosome8Mock;
    private ServiceSNPChromosome9 serviceSNPChromosome9Mock;
    ...
    public void setUpTest() {
        ...
        serviceSNPChromosome1Mock = mock(ServiceSNPChromosome1.class);
        controller.setServiceSNPChromosome1(serviceSNPChromosome1Mock);
        serviceSNPChromosome3Mock = mock(ServiceSNPChromosome3.class);
        controller.setServiceSNPChromosome3(serviceSNPChromosome3Mock);
        serviceSNPChromosome4Mock = mock(ServiceSNPChromosome4.class);
        controller.setServiceSNPChromosome4(serviceSNPChromosome4Mock);
        serviceSNPChromosome5Mock = mock(ServiceSNPChromosome5.class);
        controller.setServiceSNPChromosome5(serviceSNPChromosome5Mock);
        serviceSNPChromosome6Mock = mock(ServiceSNPChromosome6.class);
        controller.setServiceSNPChromosome6(serviceSNPChromosome6Mock);
        serviceSNPChromosome7Mock = mock(ServiceSNPChromosome7.class);
        controller.setServiceSNPChromosome7(serviceSNPChromosome7Mock);
        serviceSNPChromosome8Mock = mock(ServiceSNPChromosome8.class);
        controller.setServiceSNPChromosome8(serviceSNPChromosome8Mock);
        serviceSNPChromosome9Mock = mock(ServiceSNPChromosome9.class);
