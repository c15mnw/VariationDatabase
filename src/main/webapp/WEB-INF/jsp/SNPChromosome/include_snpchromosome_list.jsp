...
<c:if test="${SNPChromosome != null && SNPChromosome.totalPages != 0}">
    ...
    <table>
        ...
        <tbody>
        <c:forEach items="${SNPChromosome.content}" var="snpchromosome" varStatus="rowStatus">
            <tr>
                ...
                <td><c:out value="${snpchromosome.region}"/></td>
                <td><c:out value="${snpchromosome.ensemblGene}"/></td>
                <td><c:out value="${snpchromosome.ensemblTranscript}"/></td>
                <td><c:out value="${snpchromosome.ensemblAnnotation}"/></td>
