...
/**
 * An entity class which contains the information of a single SNPChromosome15 Table Row.
 * @author Mike Wicks
 */
@Entity
@Table(name = "VSC_SNP_CHROMOSOME_15")
@Transactional

public class SNPChromosome15 {
     ...
     */
    public boolean isSameAs(SNPChromosome15 snpchromosome){
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SNPChromosome15) && (oid != null) 
        		? oid.equals(((SNPChromosome15) other).oid) 
        		: (other == this);
    }
    ...
    // SNPChromosome15 Builder ---------------------------------------------------------------------
    /**
     * Gets a builder which is used to create SNPChromosome15 objects.
     * 
    ...
    /**
     * A Builder class used to create new SNPChromosome15 objects.
     */
    public static class Builder {
    	
        SNPChromosome15 built;
        ...
        /**
         * Builds the new SNPChromosome15 object.
         * 
         * @return this. The created SNPChromosome15 object.
         */
        public SNPChromosome15 build() {
