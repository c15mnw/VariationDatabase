...
/**
 * An entity class which contains the information of a single SNPChromosome25 Table Row.
 * @author Mike Wicks
 */
@Entity
@Table(name = "VSC_SNP_CHROMOSOME_25")
@Transactional

public class SNPChromosome25 {
     ...
     */
    public boolean isSameAs(SNPChromosome25 snpchromosome){
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SNPChromosome25) && (oid != null) 
        		? oid.equals(((SNPChromosome25) other).oid) 
        		: (other == this);
    }
    ...
    // SNPChromosome25 Builder ---------------------------------------------------------------------
    /**
     * Gets a builder which is used to create SNPChromosome25 objects.
     * 
    ...
    /**
     * A Builder class used to create new SNPChromosome25 objects.
     */
    public static class Builder {
    	
        SNPChromosome25 built;
        ...
        /**
         * Builds the new SNPChromosome25 object.
         * 
         * @return this. The created SNPChromosome25 object.
         */
        public SNPChromosome25 build() {
