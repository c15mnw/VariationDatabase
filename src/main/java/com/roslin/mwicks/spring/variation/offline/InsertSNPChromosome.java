                ...
                if ( dir.exists() ) {
            		...
            		for ( File file : filesFile ) {
            			...
            			if ( !file.getName().equals(".DS_Store") ) {
                			...
                			System.out.println(StringUtility.pad(totalFileCount, 3, PAD_CHAR) + " : Directory : " + directory + " : " + file.getName() + " : records : " + StringUtility.pad(snpchromosomeList.size(), 8, PAD_CHAR));
