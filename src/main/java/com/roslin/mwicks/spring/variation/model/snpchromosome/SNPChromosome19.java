...
/**
 * An entity class which contains the information of a single SNPChromosome19 Table Row.
 * @author Mike Wicks
 */
@Entity
@Table(name = "VSC_SNP_CHROMOSOME_19")
@Transactional

public class SNPChromosome19 {
     ...
     */
    public boolean isSameAs(SNPChromosome19 snpchromosome){
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SNPChromosome19) && (oid != null) 
        		? oid.equals(((SNPChromosome19) other).oid) 
        		: (other == this);
    }
    ...
    // SNPChromosome19 Builder ---------------------------------------------------------------------
    /**
     * Gets a builder which is used to create SNPChromosome19 objects.
     * 
    ...
    /**
     * A Builder class used to create new SNPChromosome19 objects.
     */
    public static class Builder {
    	
        SNPChromosome19 built;
        ...
        /**
         * Builds the new SNPChromosome19 object.
         * 
         * @return this. The created SNPChromosome19 object.
         */
        public SNPChromosome19 build() {
