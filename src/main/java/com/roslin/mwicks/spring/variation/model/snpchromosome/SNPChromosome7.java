...
/**
 * An entity class which contains the information of a single SNPChromosome7 Table Row.
 * @author Mike Wicks
 */
@Entity
@Table(name = "VSC_SNP_CHROMOSOME_7")
@Transactional

public class SNPChromosome7 {
     ...
     */
    public boolean isSameAs(SNPChromosome7 snpchromosome){
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SNPChromosome7) && (oid != null) 
        		? oid.equals(((SNPChromosome7) other).oid) 
        		: (other == this);
    }
    ...
    // SNPChromosome7 Builder ---------------------------------------------------------------------
    /**
     * Gets a builder which is used to create SNPChromosome7 objects.
     * 
    ...
    /**
     * A Builder class used to create new SNPChromosome7 objects.
     */
    public static class Builder {
    	
        SNPChromosome7 built;
        ...
        /**
         * Builds the new SNPChromosome7 object.
         * 
         * @return this. The created SNPChromosome7 object.
         */
        public SNPChromosome7 build() {
