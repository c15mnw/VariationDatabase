...
/**
 * An entity class which contains the information of a single SNPChromosome8 Table Row.
 * @author Mike Wicks
 */
@Entity
@Table(name = "VSC_SNP_CHROMOSOME_8")
@Transactional

public class SNPChromosome8 {
     ...
     */
    public boolean isSameAs(SNPChromosome8 snpchromosome){
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SNPChromosome8) && (oid != null) 
        		? oid.equals(((SNPChromosome8) other).oid) 
        		: (other == this);
    }
    ...
    // SNPChromosome8 Builder ---------------------------------------------------------------------
    /**
     * Gets a builder which is used to create SNPChromosome8 objects.
     * 
    ...
    /**
     * A Builder class used to create new SNPChromosome8 objects.
     */
    public static class Builder {
    	
        SNPChromosome8 built;
        ...
        /**
         * Builds the new SNPChromosome8 object.
         * 
         * @return this. The created SNPChromosome8 object.
         */
        public SNPChromosome8 build() {
