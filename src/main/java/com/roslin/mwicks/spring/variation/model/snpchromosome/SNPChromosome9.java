...
/**
 * An entity class which contains the information of a single SNPChromosome9 Table Row.
 * @author Mike Wicks
 */
@Entity
@Table(name = "VSC_SNP_CHROMOSOME_9")
@Transactional

public class SNPChromosome9 {
     ...
     */
    public boolean isSameAs(SNPChromosome9 snpchromosome){
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SNPChromosome9) && (oid != null) 
        		? oid.equals(((SNPChromosome9) other).oid) 
        		: (other == this);
    }
    ...
    // SNPChromosome9 Builder ---------------------------------------------------------------------
    /**
     * Gets a builder which is used to create SNPChromosome9 objects.
     * 
    ...
    /**
     * A Builder class used to create new SNPChromosome9 objects.
     */
    public static class Builder {
    	
        SNPChromosome9 built;
        ...
        /**
         * Builds the new SNPChromosome9 object.
         * 
         * @return this. The created SNPChromosome9 object.
         */
        public SNPChromosome9 build() {
