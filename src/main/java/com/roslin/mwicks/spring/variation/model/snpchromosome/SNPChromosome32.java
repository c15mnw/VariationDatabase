...
/**
 * An entity class which contains the information of a single SNPChromosome32 Table Row.
 * @author Mike Wicks
 */
@Entity
@Table(name = "VSC_SNP_CHROMOSOME_32")
@Transactional

public class SNPChromosome32 {
     ...
     */
    public boolean isSameAs(SNPChromosome32 snpchromosome){
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SNPChromosome32) && (oid != null) 
        		? oid.equals(((SNPChromosome32) other).oid) 
        		: (other == this);
    }
    ...
    // SNPChromosome32 Builder ---------------------------------------------------------------------
    /**
     * Gets a builder which is used to create SNPChromosome32 objects.
     * 
    ...
    /**
     * A Builder class used to create new SNPChromosome32 objects.
     */
    public static class Builder {
    	
        SNPChromosome32 built;
        ...
        /**
         * Builds the new SNPChromosome32 object.
         * 
         * @return this. The created SNPChromosome32 object.
         */
        public SNPChromosome32 build() {
