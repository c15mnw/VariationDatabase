...
/**
 * An entity class which contains the information of a single SNPChromosome6 Table Row.
 * @author Mike Wicks
 */
@Entity
@Table(name = "VSC_SNP_CHROMOSOME_6")
@Transactional

public class SNPChromosome6 {
     ...
     */
    public boolean isSameAs(SNPChromosome6 snpchromosome){
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SNPChromosome6) && (oid != null) 
        		? oid.equals(((SNPChromosome6) other).oid) 
        		: (other == this);
    }
    ...
    // SNPChromosome6 Builder ---------------------------------------------------------------------
    /**
     * Gets a builder which is used to create SNPChromosome6 objects.
     * 
    ...
    /**
     * A Builder class used to create new SNPChromosome6 objects.
     */
    public static class Builder {
    	
        SNPChromosome6 built;
        ...
        /**
         * Builds the new SNPChromosome6 object.
         * 
         * @return this. The created SNPChromosome6 object.
         */
        public SNPChromosome6 build() {
