...
/**
 * An entity class which contains the information of a single SNPChromosome11 Table Row.
 * @author Mike Wicks
 */
@Entity
@Table(name = "VSC_SNP_CHROMOSOME_11")
@Transactional

public class SNPChromosome11 {
     ...
     */
    public boolean isSameAs(SNPChromosome11 snpchromosome){
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SNPChromosome11) && (oid != null) 
        		? oid.equals(((SNPChromosome11) other).oid) 
        		: (other == this);
    }
    ...
    // SNPChromosome11 Builder ---------------------------------------------------------------------
    /**
     * Gets a builder which is used to create SNPChromosome11 objects.
     * 
    ...
    /**
     * A Builder class used to create new SNPChromosome11 objects.
     */
    public static class Builder {
    	
        SNPChromosome11 built;
        ...
        /**
         * Builds the new SNPChromosome11 object.
         * 
         * @return this. The created SNPChromosome11 object.
         */
        public SNPChromosome11 build() {
