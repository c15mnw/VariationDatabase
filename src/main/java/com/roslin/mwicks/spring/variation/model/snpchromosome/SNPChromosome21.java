...
/**
 * An entity class which contains the information of a single SNPChromosome21 Table Row.
 * @author Mike Wicks
 */
@Entity
@Table(name = "VSC_SNP_CHROMOSOME_21")
@Transactional

public class SNPChromosome21 {
     ...
     */
    public boolean isSameAs(SNPChromosome21 snpchromosome){
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SNPChromosome21) && (oid != null) 
        		? oid.equals(((SNPChromosome21) other).oid) 
        		: (other == this);
    }
    ...
    // SNPChromosome21 Builder ---------------------------------------------------------------------
    /**
     * Gets a builder which is used to create SNPChromosome21 objects.
     * 
    ...
    /**
     * A Builder class used to create new SNPChromosome21 objects.
     */
    public static class Builder {
    	
        SNPChromosome21 built;
        ...
        /**
         * Builds the new SNPChromosome21 object.
         * 
         * @return this. The created SNPChromosome21 object.
         */
        public SNPChromosome21 build() {
