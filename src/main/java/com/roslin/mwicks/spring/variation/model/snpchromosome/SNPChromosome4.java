...
/**
 * An entity class which contains the information of a single SNPChromosome4 Table Row.
 * @author Mike Wicks
 */
@Entity
@Table(name = "VSC_SNP_CHROMOSOME_4")
@Transactional

public class SNPChromosome4 {
     ...
     */
    public boolean isSameAs(SNPChromosome4 snpchromosome){
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SNPChromosome4) && (oid != null) 
        		? oid.equals(((SNPChromosome4) other).oid) 
        		: (other == this);
    }
    ...
    // SNPChromosome4 Builder ---------------------------------------------------------------------
    /**
     * Gets a builder which is used to create SNPChromosome4 objects.
     * 
    ...
    /**
     * A Builder class used to create new SNPChromosome4 objects.
     */
    public static class Builder {
    	
        SNPChromosome4 built;
        ...
        /**
         * Builds the new SNPChromosome4 object.
         * 
         * @return this. The created SNPChromosome4 object.
         */
        public SNPChromosome4 build() {
