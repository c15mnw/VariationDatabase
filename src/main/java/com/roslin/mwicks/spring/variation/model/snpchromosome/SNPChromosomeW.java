...
/**
 * An entity class which contains the information of a single SNPChromosomeW Table Row.
 * @author Mike Wicks
 */
@Entity
@Table(name = "VSC_SNP_CHROMOSOME_W")
@Transactional

public class SNPChromosomeW {
     ...
     */
    public boolean isSameAs(SNPChromosomeW snpchromosome){
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SNPChromosomeW) && (oid != null) 
        		? oid.equals(((SNPChromosomeW) other).oid) 
        		: (other == this);
    }
    ...
    // SNPChromosomeW Builder ---------------------------------------------------------------------
    /**
     * Gets a builder which is used to create SNPChromosomeW objects.
     * 
    ...
    /**
     * A Builder class used to create new SNPChromosomeW objects.
     */
    public static class Builder {
    	
        SNPChromosomeW built;
        ...
        /**
         * Builds the new SNPChromosomeW object.
         * 
         * @return this. The created SNPChromosomeW object.
         */
        public SNPChromosomeW build() {
