...
/**
 * An entity class which contains the information of a single SNPChromosome28 Table Row.
 * @author Mike Wicks
 */
@Entity
@Table(name = "VSC_SNP_CHROMOSOME_28")
@Transactional

public class SNPChromosome28 {
     ...
     */
    public boolean isSameAs(SNPChromosome28 snpchromosome){
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SNPChromosome28) && (oid != null) 
        		? oid.equals(((SNPChromosome28) other).oid) 
        		: (other == this);
    }
    ...
    // SNPChromosome28 Builder ---------------------------------------------------------------------
    /**
     * Gets a builder which is used to create SNPChromosome28 objects.
     * 
    ...
    /**
     * A Builder class used to create new SNPChromosome28 objects.
     */
    public static class Builder {
    	
        SNPChromosome28 built;
        ...
        /**
         * Builds the new SNPChromosome28 object.
         * 
         * @return this. The created SNPChromosome28 object.
         */
        public SNPChromosome28 build() {
