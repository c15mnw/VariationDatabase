...
/**
 * An entity class which contains the information of a single SNPChromosome10 Table Row.
 * @author Mike Wicks
 */
@Entity
@Table(name = "VSC_SNP_CHROMOSOME_10")
@Transactional

public class SNPChromosome10 {
     ...
     */
    public boolean isSameAs(SNPChromosome10 snpchromosome){
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SNPChromosome10) && (oid != null) 
        		? oid.equals(((SNPChromosome10) other).oid) 
        		: (other == this);
    }
    ...
    // SNPChromosome10 Builder ---------------------------------------------------------------------
    /**
     * Gets a builder which is used to create SNPChromosome10 objects.
     * 
    ...
    /**
     * A Builder class used to create new SNPChromosome10 objects.
     */
    public static class Builder {
    	
        SNPChromosome10 built;
        ...
        /**
         * Builds the new SNPChromosome10 object.
         * 
         * @return this. The created SNPChromosome10 object.
         */
        public SNPChromosome10 build() {
