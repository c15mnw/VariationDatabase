...
/**
 * An entity class which contains the information of a single SNPChromosome12 Table Row.
 * @author Mike Wicks
 */
@Entity
@Table(name = "VSC_SNP_CHROMOSOME_12")
@Transactional

public class SNPChromosome12 {
     ...
     */
    public boolean isSameAs(SNPChromosome12 snpchromosome){
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SNPChromosome12) && (oid != null) 
        		? oid.equals(((SNPChromosome12) other).oid) 
        		: (other == this);
    }
    ...
    // SNPChromosome12 Builder ---------------------------------------------------------------------
    /**
     * Gets a builder which is used to create SNPChromosome12 objects.
     * 
    ...
    /**
     * A Builder class used to create new SNPChromosome12 objects.
     */
    public static class Builder {
    	
        SNPChromosome12 built;
        ...
        /**
         * Builds the new SNPChromosome12 object.
         * 
         * @return this. The created SNPChromosome12 object.
         */
        public SNPChromosome12 build() {
