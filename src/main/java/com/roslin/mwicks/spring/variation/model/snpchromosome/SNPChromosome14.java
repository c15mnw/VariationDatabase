...
/**
 * An entity class which contains the information of a single SNPChromosome14 Table Row.
 * @author Mike Wicks
 */
@Entity
@Table(name = "VSC_SNP_CHROMOSOME_14")
@Transactional

public class SNPChromosome14 {
     ...
     */
    public boolean isSameAs(SNPChromosome14 snpchromosome){
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SNPChromosome14) && (oid != null) 
        		? oid.equals(((SNPChromosome14) other).oid) 
        		: (other == this);
    }
    ...
    // SNPChromosome14 Builder ---------------------------------------------------------------------
    /**
     * Gets a builder which is used to create SNPChromosome14 objects.
     * 
    ...
    /**
     * A Builder class used to create new SNPChromosome14 objects.
     */
    public static class Builder {
    	
        SNPChromosome14 built;
        ...
        /**
         * Builds the new SNPChromosome14 object.
         * 
         * @return this. The created SNPChromosome14 object.
         */
        public SNPChromosome14 build() {
