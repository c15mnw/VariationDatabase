...
/**
 * Declares methods used to obtain and modify SNPChromosome18 information.
 * @author Mike Wicks
 */
public interface ServiceSNPChromosome18  {
     ...
     */
	public <T extends SNPChromosome18> Collection<T> bulkSave(int intBatchSize, Collection<T> entities);
     ...
     */
    public SNPChromosome18 update(SNPChromosome updated) throws ExceptionSNPChromosomeNotFound;
     ...
     */
    public SNPChromosome18 findByOid(Long oid);
