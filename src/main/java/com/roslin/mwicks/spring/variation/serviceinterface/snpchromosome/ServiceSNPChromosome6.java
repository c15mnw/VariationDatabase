...
/**
 * Declares methods used to obtain and modify SNPChromosome6 information.
 * @author Mike Wicks
 */
public interface ServiceSNPChromosome6 {
     ...
     * @throws SNPChromosome6NotFoundException  if no snpchromosome is found with the given id.
     */
     ...
     * @throws SNPChromosome6NotFoundException  if no snpchromosome is found with given id.
     */
    public SNPChromosome6 update(SNPChromosome updated) throws ExceptionSNPChromosomeNotFound;

    /**
     * Searches SNPChromosome6s by using the search criteria given as a parameter.
     * @param searchCriteria
     * @param pageIndex
     * @return  A Page of SNPChromosome6s matching with the search criteria. 
     ...
     * Searches SNPChromosome6s by using the search criteria given as a parameter.
     * @param searchCriteria
     * @return  A list of SNPChromosome6s matching with the search criteria. 
     *          If no SNPChromosome6s is found, this method returns an empty list.
     */
