 ...
 */
@Entity
@Table(name = "VSC_SNP_CHROMOSOME_1")
@Transactional

public class SNPChromosome1 {
     ...
     */
    public boolean isSameAs(SNPChromosome1 snpchromosome){
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SNPChromosome1) && (oid != null) 
        		? oid.equals(((SNPChromosome1) other).oid) 
        		: (other == this);
    }
