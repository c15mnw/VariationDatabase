...
/**
 * Declares methods used to obtain and modify SNPChromosome5 information.
 * @author Mike Wicks
 */
public interface ServiceSNPChromosome5 {
     ...
     * @throws SNPChromosome5NotFoundException  if no snpchromosome is found with the given id.
     */
     ...
     * @throws SNPChromosome5NotFoundException  if no snpchromosome is found with given id.
     */
    public SNPChromosome5 update(SNPChromosome updated) throws ExceptionSNPChromosomeNotFound;

    /**
     * Searches SNPChromosome5s by using the search criteria given as a parameter.
     * @param searchCriteria
     * @param pageIndex
     * @return  A Page of SNPChromosome5s matching with the search criteria. 
     ...
     * Searches SNPChromosome5s by using the search criteria given as a parameter.
     * @param searchCriteria
     * @return  A list of SNPChromosome5s matching with the search criteria. 
     *          If no SNPChromosome5s is found, this method returns an empty list.
     */
