...
/**
 * An entity class which contains the information of a single SNPChromosome27 Table Row.
 * @author Mike Wicks
 */
@Entity
@Table(name = "VSC_SNP_CHROMOSOME_27")
@Transactional

public class SNPChromosome27 {
     ...
     */
    public boolean isSameAs(SNPChromosome27 snpchromosome){
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SNPChromosome27) && (oid != null) 
        		? oid.equals(((SNPChromosome27) other).oid) 
        		: (other == this);
    }
    ...
    // SNPChromosome27 Builder ---------------------------------------------------------------------
    /**
     * Gets a builder which is used to create SNPChromosome27 objects.
     * 
    ...
    /**
     * A Builder class used to create new SNPChromosome27 objects.
     */
    public static class Builder {
    	
        SNPChromosome27 built;
        ...
        /**
         * Builds the new SNPChromosome27 object.
         * 
         * @return this. The created SNPChromosome27 object.
         */
        public SNPChromosome27 build() {
