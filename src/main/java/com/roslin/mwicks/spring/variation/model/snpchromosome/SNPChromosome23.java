...
/**
 * An entity class which contains the information of a single SNPChromosome23 Table Row.
 * @author Mike Wicks
 */
@Entity
@Table(name = "VSC_SNP_CHROMOSOME_23")
@Transactional

public class SNPChromosome23 {
     ...
     */
    public boolean isSameAs(SNPChromosome23 snpchromosome){
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SNPChromosome23) && (oid != null) 
        		? oid.equals(((SNPChromosome23) other).oid) 
        		: (other == this);
    }
    ...
    // SNPChromosome23 Builder ---------------------------------------------------------------------
    /**
     * Gets a builder which is used to create SNPChromosome23 objects.
     * 
    ...
    /**
     * A Builder class used to create new SNPChromosome23 objects.
     */
    public static class Builder {
    	
        SNPChromosome23 built;
        ...
        /**
         * Builds the new SNPChromosome23 object.
         * 
         * @return this. The created SNPChromosome23 object.
         */
        public SNPChromosome23 build() {
