...
/**
 * Declares methods used to obtain and modify SNPChromosome4 information.
 * @author Mike Wicks
 */
public interface ServiceSNPChromosome4 {
     ...
     * @throws SNPChromosome4NotFoundException  if no snpchromosome is found with the given id.
     */
     ...
     * @throws SNPChromosome4NotFoundException  if no snpchromosome is found with given id.
     */
    public SNPChromosome4 update(SNPChromosome updated) throws ExceptionSNPChromosomeNotFound;

    /**
     * Searches SNPChromosome4s by using the search criteria given as a parameter.
     * @param searchCriteria
     * @param pageIndex
     * @return  A Page of SNPChromosome4s matching with the search criteria. 
     ...
     * Searches SNPChromosome4s by using the search criteria given as a parameter.
     * @param searchCriteria
     * @return  A list of SNPChromosome4s matching with the search criteria. 
     *          If no SNPChromosome4s is found, this method returns an empty list.
     */
