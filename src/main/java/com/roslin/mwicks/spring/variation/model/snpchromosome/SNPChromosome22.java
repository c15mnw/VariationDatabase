...
/**
 * An entity class which contains the information of a single SNPChromosome22 Table Row.
 * @author Mike Wicks
 */
@Entity
@Table(name = "VSC_SNP_CHROMOSOME_22")
@Transactional

public class SNPChromosome22 {
     ...
     */
    public boolean isSameAs(SNPChromosome22 snpchromosome){
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SNPChromosome22) && (oid != null) 
        		? oid.equals(((SNPChromosome22) other).oid) 
        		: (other == this);
    }
    ...
    // SNPChromosome22 Builder ---------------------------------------------------------------------
    /**
     * Gets a builder which is used to create SNPChromosome22 objects.
     * 
    ...
    /**
     * A Builder class used to create new SNPChromosome22 objects.
     */
    public static class Builder {
    	
        SNPChromosome22 built;
        ...
        /**
         * Builds the new SNPChromosome22 object.
         * 
         * @return this. The created SNPChromosome22 object.
         */
        public SNPChromosome22 build() {
