...
/**
 * An entity class which contains the information of a single SNPChromosome16 Table Row.
 * @author Mike Wicks
 */
@Entity
@Table(name = "VSC_SNP_CHROMOSOME_16")
@Transactional

public class SNPChromosome16 {
     ...
     */
    public boolean isSameAs(SNPChromosome16 snpchromosome){
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SNPChromosome16) && (oid != null) 
        		? oid.equals(((SNPChromosome16) other).oid) 
        		: (other == this);
    }
    ...
    // SNPChromosome16 Builder ---------------------------------------------------------------------
    /**
     * Gets a builder which is used to create SNPChromosome16 objects.
     * 
    ...
    /**
     * A Builder class used to create new SNPChromosome16 objects.
     */
    public static class Builder {
    	
        SNPChromosome16 built;
        ...
        /**
         * Builds the new SNPChromosome16 object.
         * 
         * @return this. The created SNPChromosome16 object.
         */
        public SNPChromosome16 build() {
