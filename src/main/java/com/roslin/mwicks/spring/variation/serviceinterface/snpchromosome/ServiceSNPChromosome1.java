...
/**
 * Declares methods used to obtain and modify SNPChromosome1 information.
 * @author Mike Wicks
 */
public interface ServiceSNPChromosome1 {
     ...
     * @throws SNPChromosome1NotFoundException  if no snpchromosome is found with the given id.
     */
     ...
     * @throws SNPChromosome1NotFoundException  if no snpchromosome is found with given id.
     */
    public SNPChromosome1 update(SNPChromosome updated) throws ExceptionSNPChromosomeNotFound;

    /**
     * Searches SNPChromosome1s by using the search criteria given as a parameter.
     * @param searchCriteria
     * @param pageIndex
     * @return  A Page of SNPChromosome1s matching with the search criteria. 
     ...
     * Searches SNPChromosome1s by using the search criteria given as a parameter.
     * @param searchCriteria
     * @return  A list of SNPChromosome1s matching with the search criteria. 
     *          If no SNPChromosome1s is found, this method returns an empty list.
     */
