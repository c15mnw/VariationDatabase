...
/**
 * Declares methods used to obtain and modify SNPChromosome7 information.
 * @author Mike Wicks
 */
public interface ServiceSNPChromosome7 {
     ...
     */
	public <T extends SNPChromosome7> Collection<T> bulkSave(int intBatchSize, Collection<T> entities);
     ...
     * @throws SNPChromosome7NotFoundException  if no snpchromosome is found with the given id.
     */
     ...
     * @throws SNPChromosome7NotFoundException  if no snpchromosome is found with given id.
     */
    public SNPChromosome7 update(SNPChromosome updated) throws ExceptionSNPChromosomeNotFound;

    /**
     * Searches SNPChromosome7s by using the search criteria given as a parameter.
     * @param searchCriteria
     * @param pageIndex
     * @return  A Page of SNPChromosome7s matching with the search criteria. 
     ...
     * Searches SNPChromosome7s by using the search criteria given as a parameter.
     * @param searchCriteria
     * @return  A list of SNPChromosome7s matching with the search criteria. 
     *          If no SNPChromosome7s is found, this method returns an empty list.
     */
     ...
     */
    public SNPChromosome7 findByOid(Long oid);
