...
/**
 * An entity class which contains the information of a single SNPChromosome24 Table Row.
 * @author Mike Wicks
 */
@Entity
@Table(name = "VSC_SNP_CHROMOSOME_24")
@Transactional

public class SNPChromosome24 {
     ...
     */
    public boolean isSameAs(SNPChromosome24 snpchromosome){
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SNPChromosome24) && (oid != null) 
        		? oid.equals(((SNPChromosome24) other).oid) 
        		: (other == this);
    }
    ...
    // SNPChromosome24 Builder ---------------------------------------------------------------------
    /**
     * Gets a builder which is used to create SNPChromosome24 objects.
     * 
    ...
    /**
     * A Builder class used to create new SNPChromosome24 objects.
     */
    public static class Builder {
    	
        SNPChromosome24 built;
        ...
        /**
         * Builds the new SNPChromosome24 object.
         * 
         * @return this. The created SNPChromosome24 object.
         */
        public SNPChromosome24 build() {
