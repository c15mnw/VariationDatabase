...
/**
 * An entity class which contains the information of a single SNPChromosome20 Table Row.
 * @author Mike Wicks
 */
@Entity
@Table(name = "VSC_SNP_CHROMOSOME_20")
@Transactional

public class SNPChromosome20 {
     ...
     */
    public boolean isSameAs(SNPChromosome20 snpchromosome){
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SNPChromosome20) && (oid != null) 
        		? oid.equals(((SNPChromosome20) other).oid) 
        		: (other == this);
    }
    ...
    // SNPChromosome20 Builder ---------------------------------------------------------------------
    /**
     * Gets a builder which is used to create SNPChromosome20 objects.
     * 
    ...
    /**
     * A Builder class used to create new SNPChromosome20 objects.
     */
    public static class Builder {
    	
        SNPChromosome20 built;
        ...
        /**
         * Builds the new SNPChromosome20 object.
         * 
         * @return this. The created SNPChromosome20 object.
         */
        public SNPChromosome20 build() {
