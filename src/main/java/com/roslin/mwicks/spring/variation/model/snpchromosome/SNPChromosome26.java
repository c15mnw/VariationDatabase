...
/**
 * An entity class which contains the information of a single SNPChromosome26 Table Row.
 * @author Mike Wicks
 */
@Entity
@Table(name = "VSC_SNP_CHROMOSOME_26")
@Transactional

public class SNPChromosome26 {
     ...
     */
    public boolean isSameAs(SNPChromosome26 snpchromosome){
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SNPChromosome26) && (oid != null) 
        		? oid.equals(((SNPChromosome26) other).oid) 
        		: (other == this);
    }
    ...
    // SNPChromosome26 Builder ---------------------------------------------------------------------
    /**
     * Gets a builder which is used to create SNPChromosome26 objects.
     * 
    ...
    /**
     * A Builder class used to create new SNPChromosome26 objects.
     */
    public static class Builder {
    	
        SNPChromosome26 built;
        ...
        /**
         * Builds the new SNPChromosome26 object.
         * 
         * @return this. The created SNPChromosome26 object.
         */
        public SNPChromosome26 build() {
