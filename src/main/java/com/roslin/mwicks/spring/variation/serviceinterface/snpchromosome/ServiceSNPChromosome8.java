...
/**
 * Declares methods used to obtain and modify SNPChromosome8 information.
 * @author Mike Wicks
 */
public interface ServiceSNPChromosome8 {
     ...
     * @throws SNPChromosome8NotFoundException  if no snpchromosome is found with the given id.
     */
     ...
     * @throws SNPChromosome8NotFoundException  if no snpchromosome is found with given id.
     */
    public SNPChromosome8 update(SNPChromosome updated) throws ExceptionSNPChromosomeNotFound;

    /**
     * Searches SNPChromosome8s by using the search criteria given as a parameter.
     * @param searchCriteria
     * @param pageIndex
     * @return  A Page of SNPChromosome8s matching with the search criteria. 
     ...
     * Searches SNPChromosome8s by using the search criteria given as a parameter.
     * @param searchCriteria
     * @return  A list of SNPChromosome8s matching with the search criteria. 
     *          If no SNPChromosome8s is found, this method returns an empty list.
     */
