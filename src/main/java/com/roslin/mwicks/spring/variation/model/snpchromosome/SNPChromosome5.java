...
/**
 * An entity class which contains the information of a single SNPChromosome5 Table Row.
 * @author Mike Wicks
 */
@Entity
@Table(name = "VSC_SNP_CHROMOSOME_5")
@Transactional

public class SNPChromosome5 {
     ...
     */
    public boolean isSameAs(SNPChromosome5 snpchromosome){
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SNPChromosome5) && (oid != null) 
        		? oid.equals(((SNPChromosome5) other).oid) 
        		: (other == this);
    }
    ...
    // SNPChromosome5 Builder ---------------------------------------------------------------------
    /**
     * Gets a builder which is used to create SNPChromosome5 objects.
     * 
    ...
    /**
     * A Builder class used to create new SNPChromosome5 objects.
     */
    public static class Builder {
    	
        SNPChromosome5 built;
        ...
        /**
         * Builds the new SNPChromosome5 object.
         * 
         * @return this. The created SNPChromosome5 object.
         */
        public SNPChromosome5 build() {
