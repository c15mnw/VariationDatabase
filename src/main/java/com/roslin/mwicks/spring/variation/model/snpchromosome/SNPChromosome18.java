...
/**
 * An entity class which contains the information of a single SNPChromosome18 Table Row.
 * @author Mike Wicks
 */
@Entity
@Table(name = "VSC_SNP_CHROMOSOME_18")
@Transactional

public class SNPChromosome18 {
     ...
     */
    public boolean isSameAs(SNPChromosome18 snpchromosome){
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SNPChromosome18) && (oid != null) 
        		? oid.equals(((SNPChromosome18) other).oid) 
        		: (other == this);
    }
    ...
    // SNPChromosome18 Builder ---------------------------------------------------------------------
    /**
     * Gets a builder which is used to create SNPChromosome18 objects.
     * 
    ...
    /**
     * A Builder class used to create new SNPChromosome18 objects.
     */
    public static class Builder {
    	
        SNPChromosome18 built;
        ...
        /**
         * Builds the new SNPChromosome18 object.
         * 
         * @return this. The created SNPChromosome18 object.
         */
        public SNPChromosome18 build() {
